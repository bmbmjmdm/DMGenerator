...
"Guards show up to arrest the NPC or PC",
...
"A courier delivers a mysterious package to the NPC",
"A local authority figure interrupts, demanding answers.",
"A rival adventuring party arrives, boasting about their achievements.",
"A secret message is delivered to the NPC",
"A friend/relative of the NPC arrives with urgent news",
"A trusted friend of the NPC advises them against helping the PCs",
"A romantic interest of the NPC shows up, making them act differently",
"The NPC's superior arrives, making them act differently",
"An NPC’s ally suddenly arrives and tries to take control of the conversation.",
"A rival of the NPC shows up, challenging their authority in front of the PCs.",
"A debt collector confronts the NPC during the conversation.",
"A bounty hunter looking for the NPC interrupts.",
"The NPC wins the lottery mid-conversation",
"A rival of the PCs arrives and tries to discredit them to the NPC.",
"Another NPC interrupts with conflicting advice.",
"An annoying 'friend' of the NPC's arrives",
"An old mentor or religious leader of the NPC's shows up, altering their behavior.",
"The PCs notice a suspicious figure watching the interaction.",
"An animal companion of the NPC becomes protective and aggressive.",
"The NPC receives a threat from an unseen enemy.",
"A political figure demands the PC's or NPC’s loyalty in front of the other",
"A local leader makes an unexpected visit",
"A controversial ally of the PCs' arrives",
"A controversial ally of the NPC's arrives",
"A personal secret of the NPC is accidentally revealed.",
"The NPC tries to cast a charm on the PC",
"The NPC's bodyguard arrives and urges them to leave",
"A known, suspicious symbol is seen on the NPC's clothing",
"Someone bumps into one of the PCs, planting something on them",
"An heirloom of the NPC's is accidentally damaged.",
"Someone in the crowd casts a spell on the PC or NPC, altering their emotions, possibly becoming erratic",
"The NPC realizes something astrological and changes their mind",
"A forbidden subject is brought up, causing the NPC to react strongly.",
"Guards show up for a random search ",
"An annoying bard is trying to sing about the conversation as its happening ",
"A child runs up to the NPC, asking for help",
"A third party is heckling the NPC or PCs",
"A stray animal interupts the conversation, begging for attention. The NPC is allergic or otherwise doesn't like it",
"A drunk person won't stop interrupting",
"A small child keeps trying to pickpocket the PCs/NPC",
"A begger interupts, asking for help",
"A rumor-monger is telling lies about the PCs/NPC in the middle of the conversation",
"Someone challenges the NPC to a duel",
"A tourist is awkwardly a part of the convesration",
"The NPC makes a bet with the PCs",
"The NPC is a much more important person in disguise",
"Someone is putting up wanted posters of the PCs nearby",
"A street artist draws an unflattering caricature of the PCs.",
"A god calls out from the ether, accusing the NPC or PCs",
"A town crier announces a bounty on NPC or PC",
"A traveling seer loudly predicts doom for the PCs or NPC",
"A cloaked figure says they can help more than the current NPC, though seems suspicious",
"A natural phenomenon occurs in the sky, the NPC takes it as an ill-omen",
"A thick fog rolls in, obscuring the NPC",
"A group of hostile creatures approaches, forcing a quick decision.",
"An important item appears, wanted by both the NPC and PC",
"A tied-up person falls out of a closet",
"A corpse falls out of a closet",
"A bag of gold/loot falls through the cieling",
"The NPC takes out a weapon to 'clean' it, rising tension",
"A sudden rockslide/collapse blocks the only exit",
"A mysterious letter drops from the NPC's pocket.",
"A painting falls off the wall, revealing a hidden compartment",
"A book falls off the shelf, revealing a hidden hallway if looked through",
"A loud creak from above suggests something heavy moving.",
"A sudden draft blows out all the candles, plunging the room into darkness.",
"A strange glyph on the wall begins to glow and pulsate.",
"A trapped floor panel springs open, revealing a hidden pit with bones.",
"Multiple spiders begin crawling out from the NPC’s sleeves",
"A wooden panel falls off, revealing a peephole.",
"A strange amulet around the NPC’s neck begins to hum.",
"A tapestry falls, uncovering a hidden alcove (could have gold, poison, documents, etc)",
"The NPC’s eyes flash a different color momentarily.",
"A loud knocking starts at the door, growing more insistent. The NPC ignores it",
"The floor begins to crack and crumble",
"The NPC drops a sealed scroll with a royal seal.",
"The NPC's shadow begins to move independently.",
"A mirror becomes out of sync",
...
"NPC asks a PC to share what quality they dislike the most in others",
