export default [
    ...
    "Simply Curious About the Area",
    "Following a Rumor for Fun",
    ...
    "Killing Time and Wandering Around",
    "Avoiding a Boring Task",
    "Looking for Entertainment",
    "Checking on a Neighbor",
    "Trying to Fix a Small Mistake",
    "Looking for Directions",
    "Doing a Favor for a Stranger",
    "Trying to Earn a Little Extra Money",
    "Looking for a Cheap Place to Drink",
    "Trying to Stay Out of Trouble",
    "Avoiding Someone Annoying",
    "Looking for a Lost Item of Little Value",
    "Trying to Return Something Borrowed",
    "Looking for a Quiet Place to Think",
    "Trying to Prove a Small Point",
    "Doing Simple Chores",
    "Looking for a Ride to Town",
    "Finding a Place to Rest",
    "Trying to Get Home Safely",
    "Looking for a Bargain",
    "Trying to Repair a Broken Tool",
    "Looking for a New Hobby",
    "Trying to Avoid Work",
    "Looking for Someone to Talk To",
    "Trying to Replace Something Broken",
    "Looking for Fresh Supplies",
    "Trying to Pay Off a Small Debt",
    "Looking for a Lost Child’s Toy",
    "Trying to Make a Good First Impression",
    "Looking for a Short Cut",
    "Trying to Find the Best View",
    "Looking for a Quiet Drink",
    "Trying to Learn a Simple Skill",
    "Looking for a Place to Wash Up",
    "Looking for a Simple Thank You",
]
